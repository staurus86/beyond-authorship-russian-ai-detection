# Хеши кода и входов ревизии r11 стресс-теста

Зафиксировано **до запуска седьмой попытки P2**. Основание —
`02-preregistration/amendment-stress-r10-sentinel-bound.md`, уточнение расчёта границы.

Отметка UTC `2026-07-31T22:01:21+00:00`, по Москве `2026-08-01T01:01:21+03:00`.

Ревизия r11 уточняет ревизию r10: граница берётся как полный размах вероятности
на интервале в одну единицу последнего разряда в обе стороны и пишется с шестью
знаками мантиссы. Прежняя редакция брала односторонний сдвиг и округляла запись
до трёх знаков, из-за чего 21 строка из 1275 выходила за собственную границу на
величину порядка 1e-12.
...
| `09-tools/stress_paths.py` | входы, ревизия процедуры, каталог попытки | `34c8d011320c0f5a6d31459a4fda783dd0675702d312f7c8d18231925d61b94c` |
| `09-tools/stress_run_p2.py` | расчётный код P2 | `8290adf00984dc21372e05dad12eb511630fdcf84d4a708ea03d495efc6ecff4` |
...
| `09-tools/test_stress_gates_synth.py` | синтетический тест шлюзов | `9713f812efd553a2d1a5a537e8789ce183abf82f7729c5ef67ff3aed16a2ad42` |

Синтетический тест перед запуском: 115 проверок, провалов нет.
