# Хеши кода и входов ревизии r5 стресс-теста

Зафиксировано **до запуска цепочки ревизии r5**. Основания — `02-preregistration/amendment-stress-r5-t14-not-executable.md` и `amendment-stress-r5-lifecycle-status.md`.

Отметка UTC `2026-07-31T13:38:12+00:00`, по Москве `2026-07-31T16:38:12+03:00`.

Ревизии r2 и r3 помечены `invalidated`, r4 — `superseded`: прогон завершён штатно и служит источником деривации P4 r5, но действующей аналитической ревизией больше не является. Статусы лежат в отдельных неизменяемых записях `*-lifecycle.json`; сами манифесты r4 не редактировались, их хеши в чужих манифестах остаются верными.
...
| `09-tools/stress_run_p2.py` | расчётный код P2: реконструкция, агрегация, шлюзы | `2bb9b57a36821eda31e50be6f44e53c53fc7a963069e8cbb0b1855a01444a91b` |
...
| `09-tools/test_stress_gates_synth.py` | синтетический тест шлюзов, 67 проверок | `eae648fa3320dcf10a039bf573b452714979cc2402b543bd82512ee5ec020afc` |
