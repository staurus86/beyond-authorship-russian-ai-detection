# Процедура 2, clf-v2-legacy-r2: результаты замороженного прогона

Запуск 2026-07-31T19:03:11+00:00, seed 20260727. Хеши входов, разбиений и кода — `clf-v2r2-legacy-manifest.json`.
...
| holdout_author | main | full | 0.991 | 0.908 | 0.952 | 0.881 | 0.028 | зарегистрирован до прогона |
| holdout_author | main | net | 0.882 | 0.435 | 0.672 | 0.164 | 0.051 | зарегистрирован до прогона |
| holdout_author | main+M02 | full | 0.993 | 0.925 | 0.961 | 0.896 | 0.022 | зарегистрирован до прогона |
...
| holdout_genre_analytics | main | net | 0.986 | 0.878 | 0.940 | 0.766 | 0.079 | зарегистрирован до прогона |
...
| holdout_genre_commercial | main | full | 0.997 | 0.924 | 0.962 | 0.969 | 0.059 | зарегистрирован до прогона |
| holdout_genre_commercial | main | net | 0.997 | 0.911 | 0.955 | 0.906 | 0.087 | зарегистрирован до прогона |
| holdout_genre_commercial | main+M02 | full | 0.999 | 0.945 | 0.973 | 0.981 | 0.046 | зарегистрирован до прогона |
...
| holdout_genre_prose | main | full | — | — | — | — | 0.087 | post hoc: тест одноклассовый, определим только FPR |
| holdout_genre_prose | main | net | — | — | — | — | 0.185 | post hoc: тест одноклассовый, определим только FPR |
| holdout_genre_prose | main+M02 | full | — | — | — | — | 0.079 | post hoc: тест одноклассовый, определим только FPR |
...
| holdout_genre_seo | main | full | 0.943 | 0.652 | 0.836 | 0.031 | 0.315 | зарегистрирован до прогона |
| holdout_genre_seo | main | net | 0.898 | 0.585 | 0.801 | 0.069 | 0.348 | зарегистрирован до прогона |
| holdout_genre_seo | main+M02 | full | 0.960 | 0.682 | 0.853 | 0.128 | 0.281 | зарегистрирован до прогона |
| holdout_genre_seo | negative-control | full | 0.444 | — | — | — | — | post hoc: серия кластерных перестановок вместо одной; 20 перестановок, разброс 0.187–0.770 |
...
| holdout_model_Anthropic | main | full | 1.000 | 0.960 | 0.983 | 1.000 | 0.033 | зарегистрирован до прогона |
| holdout_model_Anthropic | main | net | 0.977 | 0.864 | 0.935 | 0.507 | 0.074 | зарегистрирован до прогона |
| holdout_model_Anthropic | main+M02 | full | 1.000 | 0.960 | 0.983 | 0.993 | 0.033 | зарегистрирован до прогона |
| holdout_model_Anthropic | negative-control | full | 0.287 | — | — | — | — | post hoc: серия кластерных перестановок вместо одной; 20 перестановок, разброс 0.001–0.970 |
...
| holdout_model_DeepSeek | main | net | 0.991 | 0.880 | 0.946 | 0.789 | 0.087 | зарегистрирован до прогона |
| holdout_model_DeepSeek | main+M02 | full | 0.997 | 0.941 | 0.971 | 0.941 | 0.026 | зарегистрирован до прогона |
| holdout_model_DeepSeek | negative-control | full | 0.384 | — | — | — | — | post hoc: серия кластерных перестановок вместо одной; 20 перестановок, разброс 0.002–0.927 |
...
| holdout_model_NVIDIA | main | full | 0.990 | 0.915 | 0.958 | 0.877 | 0.036 | зарегистрирован до прогона |
| holdout_model_NVIDIA | main | net | 0.876 | 0.421 | 0.668 | 0.149 | 0.054 | зарегистрирован до прогона |
| holdout_model_NVIDIA | main+M02 | full | 0.993 | 0.925 | 0.962 | 0.903 | 0.028 | зарегистрирован до прогона |
| holdout_model_NVIDIA | negative-control | full | 0.129 | — | — | — | — | post hoc: серия кластерных перестановок вместо одной; 20 перестановок, разброс 0.005–0.974 |
...
| holdout_model_OpenAI | main | net | 0.994 | 0.894 | 0.952 | 0.841 | 0.074 | зарегистрирован до прогона |
| holdout_model_OpenAI | main+M02 | full | 0.998 | 0.953 | 0.977 | 0.974 | 0.020 | зарегистрирован до прогона |
| holdout_model_OpenAI | negative-control | full | 0.407 | — | — | — | — | post hoc: серия кластерных перестановок вместо одной; 20 перестановок, разброс 0.010–0.965 |
...
| holdout_prompt_P1 | main | full | 0.999 | 0.963 | 0.982 | 0.978 | 0.033 | зарегистрирован до прогона |
| holdout_prompt_P1 | main | net | 0.977 | 0.848 | 0.924 | 0.625 | 0.077 | зарегистрирован до прогона |
| holdout_prompt_P1 | main+M02 | full | 0.999 | 0.966 | 0.983 | 0.978 | 0.028 | зарегистрирован до прогона |
...
| holdout_prompt_P2 | main | full | 1.000 | 0.963 | 0.982 | 1.000 | 0.036 | зарегистрирован до прогона |
| holdout_prompt_P2 | main | net | 0.986 | 0.883 | 0.942 | 0.719 | 0.092 | зарегистрирован до прогона |
...
| holdout_prompt_P3 | main | full | 0.976 | 0.841 | 0.918 | 0.641 | 0.043 | зарегистрирован до прогона |
| holdout_prompt_P3 | main | net | 0.981 | 0.861 | 0.931 | 0.760 | 0.071 | зарегистрирован до прогона |
| holdout_prompt_P3 | main+M02 | full | 0.983 | 0.845 | 0.919 | 0.674 | 0.036 | зарегистрирован до прогона |
| holdout_prompt_P3 | negative-control | full | 0.416 | — | — | — | — | post hoc: серия кластерных перестановок вместо одной; 20 перестановок, разброс 0.003–0.937 |
| holdout_prompt_P3 | source-only | full | 1.000 | 0.000 | 0.500 | 1.000 | 1.000 | зарегистрирован до прогона |
| holdout_source | format-only | full | 0.998 | 0.980 | 0.990 | 0.987 | 0.006 | зарегистрирован до прогона |
...
| holdout_source | main | net | 0.921 | 0.626 | 0.806 | 0.299 | 0.058 | зарегистрирован до прогона |
| holdout_source | main+M02 | full | 0.997 | 0.950 | 0.975 | 0.967 | 0.024 | зарегистрирован до прогона |
| holdout_source | negative-control | full | 0.256 | — | — | — | — | post hoc: серия кластерных перестановок вместо одной; 20 перестановок, разброс 0.002–0.998 |
| holdout_source | source-only | full | 0.500 | 0.000 | 0.500 | 0.000 | 1.000 | зарегистрирован до прогона |
| holdout_time | format-only | full | — | — | — | — | 0.011 | post hoc: тест одноклассовый, определим только FPR |
| holdout_time | genre-only | full | — | — | — | — | 0.856 | post hoc: тест одноклассовый, определим только FPR |
| holdout_time | length-only | full | — | — | — | — | 0.557 | post hoc: тест одноклассовый, определим только FPR |
...
| holdout_topic | main | full | 0.998 | 0.945 | 0.973 | 0.964 | 0.043 | зарегистрирован до прогона |
| holdout_topic | main | net | 0.982 | 0.872 | 0.936 | 0.713 | 0.064 | зарегистрирован до прогона |
| holdout_topic | main+M02 | full | 0.998 | 0.958 | 0.979 | 0.981 | 0.033 | зарегистрирован до прогона |
...
Сверено строк: 126; выбранный C отличался бы у **37**.
...
| holdout_genre_commercial | main | full | 1.0 | 10.0 |
| holdout_genre_commercial | main+M02 | full | 0.1 | 1.0 |
| holdout_genre_news | format-only | full | 1.0 | 10.0 |
| holdout_genre_news | main | net | 0.1 | 10.0 |
| holdout_genre_prose | format-only | full | 1.0 | 10.0 |
| holdout_genre_prose | main | full | 0.01 | 0.1 |
| holdout_genre_science | format-only | full | 1.0 | 10.0 |
| holdout_genre_science | main | net | 0.1 | 10.0 |
| holdout_genre_seo | main | full | 10.0 | 0.01 |
| holdout_genre_seo | main+M02 | full | 10.0 | 0.01 |
| holdout_genre_translation | format-only | full | 1.0 | 10.0 |
| holdout_genre_translation | main | net | 0.1 | 10.0 |
...
| holdout_source | main | net | 0.01 | 1.0 |
| holdout_source | main+M02 | full | 1.0 | 0.1 |
| holdout_source | source-only | full | 0.1 | 0.01 |
| holdout_time | format-only | full | 1.0 | 10.0 |
| holdout_time | length-only | full | 0.01 | 10.0 |
| holdout_time | main | net | 0.1 | 0.01 |
| holdout_topic | main | net | 0.01 | 0.1 |
| holdout_topic | main+M02 | full | 1.0 | 0.1 |
...
|---|---|---|---|---|---|---|
| full | outer_fold_0 | gpt | 0.995 | 0.849 | 0.889 | 133 |
| full | outer_fold_1 | real_claude | 1.000 | 1.000 | 1.000 | 150 |
| full | outer_fold_2 | deepseek_pro | 0.989 | 0.847 | 0.889 | 142 |
| full | outer_fold_3 | nemotron | 0.999 | 0.929 | 0.922 | 166 |
| full | pooled_out_of_fold | все четыре | 0.994 | 0.909 | 0.933 | 591 |
| net | outer_fold_0 | gpt | 0.984 | 0.764 | 0.733 | 133 |
| net | outer_fold_1 | real_claude | 0.979 | 0.847 | 0.678 | 150 |
| net | outer_fold_2 | deepseek_pro | 0.974 | 0.810 | 0.744 | 142 |
| net | outer_fold_3 | nemotron | 0.951 | 0.577 | 0.211 | 166 |
| net | pooled_out_of_fold | все четыре | 0.948 | 0.724 | 0.508 | 591 |
...
|---|---|---|---|---|---|---|---|
| full | P3-P1 | 120 | 15 | -0.0953 | [-0.1451; -0.0502] | 0.0014 | 0.0014 |
| full | P2-P1 | 120 | 15 | 0.0701 | [0.0492; 0.0931] | 0.0002 | 0.0002 |
| net | P3-P1 | 120 | 15 | 0.0181 | [-0.0104; 0.0486] | 0.2620 | 0.2620 |
| net | P2-P1 | 120 | 15 | 0.0812 | [0.0482; 0.1121] | 0.0010 | 0.0010 |
