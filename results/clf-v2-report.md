# Процедура 2, clf-v2-valid: результаты замороженного прогона

Запуск 2026-07-29T14:49:59+00:00, seed 20260727. Хеши входов, разбиений и кода — `clf-v2-manifest.json`.
...
| holdout_genre_news | main | net | — | — | — | — | 0.077 | post hoc: тест одноклассовый, определим только FPR |
...
| holdout_genre_prose | main | full | — | — | — | — | 0.093 | post hoc: тест одноклассовый, определим только FPR |
...
| holdout_genre_science | main | net | — | — | — | — | 0.077 | post hoc: тест одноклассовый, определим только FPR |
...
| holdout_genre_seo | main | full | 0.943 | 0.656 | 0.838 | 0.031 | 0.310 | зарегистрирован до прогона |
| holdout_genre_seo | main | net | 0.899 | 0.588 | 0.802 | 0.069 | 0.345 | зарегистрирован до прогона |
| holdout_genre_seo | main+M02 | full | 0.961 | 0.690 | 0.857 | 0.128 | 0.271 | зарегистрирован до прогона |
...
| holdout_genre_translation | main | net | — | — | — | — | 0.077 | post hoc: тест одноклассовый, определим только FPR |
...
| holdout_source | main | full | 0.995 | 0.934 | 0.967 | 0.935 | 0.037 | зарегистрирован до прогона |
| holdout_source | main | net | 0.930 | 0.595 | 0.785 | 0.391 | 0.047 | зарегистрирован до прогона |
| holdout_source | main+M02 | full | 0.997 | 0.950 | 0.975 | 0.967 | 0.024 | зарегистрирован до прогона |
| holdout_source | negative-control | full | 0.254 | — | — | — | — | post hoc: серия кластерных перестановок вместо одной; 20 перестановок, разброс 0.002–0.998 |
...
Сверено строк: 126; выбранный C отличался бы у **36**.
...
| holdout_genre_news | main | net | 0.1 | 0.01 |
...
| holdout_genre_science | main | net | 0.1 | 0.01 |
...
| holdout_genre_translation | main | net | 0.1 | 0.01 |
...
| holdout_source | main | net | 0.1 | 1.0 |
