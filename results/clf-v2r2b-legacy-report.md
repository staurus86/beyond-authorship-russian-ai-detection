# Процедура 2, clf-v2-legacy-r2b: результаты замороженного прогона

Запуск 2026-07-31T19:17:37+00:00, seed 20260727. Хеши входов, разбиений и кода — `clf-v2r2b-legacy-manifest.json`.
...
| holdout_genre_prose | main+M02 | full | — | — | — | — | 0.087 | post hoc: тест одноклассовый, определим только FPR |
...
| holdout_genre_seo | main | full | 0.993 | 0.881 | 0.949 | 0.900 | 0.077 | зарегистрирован до прогона |
...
| holdout_genre_seo | negative-control | full | 0.432 | — | — | — | — | post hoc: серия кластерных перестановок вместо одной; 20 перестановок, разброс 0.170–0.770 |
...
| holdout_source | main | net | 0.901 | 0.547 | 0.754 | 0.412 | 0.039 | зарегистрирован до прогона |
| holdout_source | main+M02 | full | 0.997 | 0.950 | 0.975 | 0.967 | 0.024 | зарегистрирован до прогона |
| holdout_source | negative-control | full | 0.242 | — | — | — | — | post hoc: серия кластерных перестановок вместо одной; 20 перестановок, разброс 0.001–0.998 |
...
| holdout_time | main | net | — | — | — | — | 0.090 | post hoc: тест одноклассовый, определим только FPR |
...
Сверено строк: 126; выбранный C отличался бы у **34**.
...
| holdout_genre_news | main | net | 0.01 | 10.0 |
...
| holdout_genre_science | main | net | 0.01 | 10.0 |
| holdout_genre_translation | format-only | full | 1.0 | 10.0 |
| holdout_genre_translation | main | net | 0.01 | 10.0 |
